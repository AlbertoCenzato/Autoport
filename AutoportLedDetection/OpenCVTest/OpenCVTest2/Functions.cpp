...
struct PinHoleEquations : Functor<double> {
	...
	PinHoleEquations(double* v, cv::Point2f* leds, cv::Point3f* points, double focal, double d_pxl) 
...
long pinHoleFSolve(Matrix<double,6,1> &variables, double* v, cv::Point2f* leds, cv::Point3f* points, double focal, double d_pxl) {
