...
struct PinHoleEquations : Functor<double> {
	...
	PinHoleEquations(double* v, double* PXL1, double* PXL2, double* PXL3, double* PXL4, double* P1_T, double* P2_T, double* P3_T, double* P4_T, double focal, double d_pxl) 
		: Functor(6,8), v(v), PXL1(PXL1), PXL2(PXL2), PXL3(PXL3), PXL4(PXL4), P1_T(P1_T), P2_T(P2_T), P3_T(P3_T), P4_T(P4_T), focal(focal), d_pxl(d_pxl) {}
...
/*
struct PinHoleEquationsUS : Functor<double> {
...
long pinHoleFSolve(Matrix<double,6,1> &variables, double* v, double* PXL1, double* PXL2, double* PXL3, double* PXL4, double* P1_T, double* P2_T, double* P3_T, double* P4_T, double focal, double d_pxl) {
	
	auto begin = chrono::high_resolution_clock::now();

	PinHoleEquations pinHoleFunctor(v, PXL1, PXL2, PXL3, PXL4, P1_T, P2_T, P3_T, P4_T, focal, d_pxl);
