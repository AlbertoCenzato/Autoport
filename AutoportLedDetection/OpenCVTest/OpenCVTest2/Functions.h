...
extern long pinHoleFSolve(Eigen::Matrix<double, 6, 1> &variables, double* v, double* PXL1, double* PXL2, double* PXL3, double* PXL4, double* P1_T, double* P2_T, double* P3_T, double* P4_T, double focal, double d_pxl);
