...
public:
	...
	PositionEstimation(Position_XYZ_YPR &initialPosition, vector<Point3d> *realWorldPoints) {
		...
		this->currRealWorldSet = realWorldPoints;
...
private:
	...
	void levenbergMarquardt() {
		...
		PinHoleEquations *pinHoleFunctor = new PinHoleEquations(*currRealWorldSet, FOCAL_X, FOCAL_Y, PIXEL_DIMENSION);
